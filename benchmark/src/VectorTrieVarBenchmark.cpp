...
using SearchOptimization = SearchStorageFixture<mtl::PersistentVectorVar<A, 4, 8>>;

BENCHMARK_DEFINE_F(SearchOptimization, RBTrieVar)
...
BENCHMARK_REGISTER_F(SearchOptimization, RBTrieVar)
