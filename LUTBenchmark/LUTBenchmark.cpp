...
BENCHMARK_REGISTER_F(VectorSearchFixture, BranchFullIt)->RangeMultiplier(0xF + 1)->Ranges({ { 0xF + 1, 0xFFFFFF + 1 }, { 0, 2 } })->Complexity()->Threads(6);
...
BENCHMARK_REGISTER_F(VectorSearchFixture, std_equal_range)->RangeMultiplier(0xF + 1)->Ranges({ { 0xF + 1, 0xFFFFFF + 1 }, { 0, 2 } })->Complexity()->Threads(6);
...
BENCHMARK_REGISTER_F(VectorSearchFixture, std_lower_bound)->RangeMultiplier(0xF + 1)->Ranges({ { 0xF + 1, 0xFFFFFF + 1 }, { 0, 2 } })->Complexity()->Threads(6);
...
BENCHMARK_REGISTER_F(VectorSearchFixture, std_partition_point)->RangeMultiplier(0xF + 1)->Ranges({ { 0xF + 1, 0xFFFFFF + 1 }, { 0, 2 } })->Complexity()->Threads(6);
